...
var table=$('#project-table').DataTable({
  ...
  "serverSide" : true,
    ...
    "sAjaxSource": "http://localhost/administrator/showInformationFile",
    ...
    "columnDefs":[
        {
            ...
            "render": function(data, type, row){
                		var html = '<a class="" href="http://localhost/administrator/downloadFile?if_id='+row.File_id+'">'+data+'</a>';
			            return html;
            }
        }
    ],
...
//导出回执
$(".export-record1").on("click",function(){
